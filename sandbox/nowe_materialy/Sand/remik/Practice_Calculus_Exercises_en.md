...
1.  **Ciągi:**
    ...
    * Podaj wzór rekurencyjny $a_{n+1} = a_n + \dots$ ciągu arytmetycznego, którego pierwszy wyraz ma wartość $5$, a dziesiąty wyraz ma wartość $23$.
    * Oblicz sumę wyrazów ciągu geometrycznego: $-1 + 2 - 4 + \dots - 64$.
    ...
    * Ile wynosi wyrażenie $1 + 2 + 4 + 8 + \dots + 2^{10}$?
...
3.  **Granice:**
    ...
    2)  Oblicz granicę funkcji rzeczywistej:
        * $$\lim_{x \to \infty} \frac{x^3 + 2x^2}{x^4 - 3x^3}$$

    3)  Znajdź asymptoty funkcji:
...
2.  **Długość, Droga:**
    ...
    1)  W Wolframie Alpha/Colabie oblicz długość krzywej sinusa na odcinku $[a, b]$, używając wzoru:
...
3.  **Równania drugiego rzędu i cząstkowe:**
...
Sprawdź, czy funkcja $\psi(t, x) = A \cos(\omega t + kx)$ jest rozwiązaniem równania różniczkowego cząstkowego drugiego rzędu (tzw. "równania falowego"), gdzie $v = \frac{\omega}{k} = \frac{2\pi / T}{2\pi / \lambda}$:
