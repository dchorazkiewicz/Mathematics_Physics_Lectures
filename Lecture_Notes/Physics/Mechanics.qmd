        ...
        <div class="controls-area">
            ...
            <div>
                ...
                <div class="presets-grid">
                    ...
                    <button class="btn-circle">Circular Orbit<br>(v = v₁)</button>
                    <button class="btn-ellipse">Ellipse<br>(v₁ &lt; v &lt; v₂)</button>
                    <button class="btn-escape">Escape<br>(v &ge; v₂)</button>
                </div>
            </div>
    ...
    (function() {
        ...
        function draw() {
            ...
            if (state.crashed) {
                ...
                ctx.textBaseline = "middle"; ctx.fillText("💥", state.x, state.y);
            }
            ctx.restore();
        }
