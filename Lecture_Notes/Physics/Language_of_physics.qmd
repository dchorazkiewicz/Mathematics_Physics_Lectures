...
html_anim/language_of_physics/vector_field.html

<iframe src="html_anim/language_of_physics/vector_field.html" width="100%" height="500px"></iframe>
[html_anim/language_of_physics/vector_field.html](html_anim/language_of_physics/vector_field.html)
...
<iframe src="html_anim/language_of_physics/derivative.html" width="100%" height="700px"></iframe>

[html_anim/language_of_physics/derivative.html](html_anim/language_of_physics/derivative.html)
...
<iframe src="html_anim/language_of_physics/integrals.html" width="100%" height="600px"></iframe>

[html_anim/language_of_physics/integrals.html](html_anim/language_of_physics/integrals.html)
...
<iframe src="html_anim/language_of_physics/diff_eqn_1ord.html" width="100%" height="600px"></iframe>

[html_anim/language_of_physics/diff_eqn_1ord.html](html_anim/language_of_physics/diff_eqn_1ord.html)
...
# Define a numerical solution for y(x) using the central difference method
def y_numerical(x, h):
    # Starting values: y(0) = sin(0) = 0, y(-h) = sin(-h) -> approximations
    # Note: Using accurate y_prev based on analytical solution for stability in this example
    y = [0]
    y_prev = np.sin(-h)
    
    current_y = y[0]
    
    # Loop needs to run len(x) - 1 times to generate the remaining points
    for i in range(len(x) - 1):
        # y(x+h) = 2y(x) - y(x-h) - h^2 * y(x)
        # This is derived from y'' = -y
        next_y = 2 * current_y - y_prev - h**2 * current_y
        y.append(next_y)
        y_prev = current_y
        current_y = next_y
        
    return y  # POPRAWKA: Zwracamy całą listę (20 elementów), nie ucinamy ostatniego
...
y_num = y_numerical(x, h)

# Compute the difference between analytical and numerical solutions
# Teraz obie tablice mają kształt (20,)
difference = y_analytical(x) - np.array(y_num)
...
# Left plot: Analytical and numerical solutions
axs[0].plot(plot_x, y_analytical(plot_x), label='Analytical', linestyle='dashed', linewidth=2)
axs[0].scatter(x, y_num, label='Numerical', color='red', zorder=5)
axs[0].set_title('Analytical vs Numerical (2nd Order)')
axs[0].set_xlabel('x')
axs[0].set_ylabel('y')
axs[0].legend()
...
# Right plot: Difference between solutions
axs[1].scatter(x, difference, label='Difference', color='red')
axs[1].plot(x, difference, linestyle=':', color='red', alpha=0.5) # Dodano linię dla czytelności
axs[1].set_title('Difference (Analytical - Numerical)')
axs[1].set_xlabel('x')
axs[1].set_ylabel('Difference')
axs[1].legend()
...
<iframe src="html_anim/language_of_physics/diff_eqn.html" width="100%" height="600px"></iframe>

[html_anim/language_of_physics/diff_eqn.html](html_anim/language_of_physics/diff_eqn.html)
...
<iframe src="html_anim/language_of_physics/gradient.html" width="100%" height="600px"></iframe>

[html_anim/language_of_physics/gradient.html](html_anim/language_of_physics/gradient.html)
